...
public class RelationTests
{
    ...
    {
        var store = DatabaseHelper.Default.Store;
        var data = new RootModel() { IntList = [1, 2, 3, 4, 5] };
    ...
    public void Test_Update_EnumerableListIndexer()
    {
        ...
        data.IntEnumerable.ShouldBe([1, 2, 10, 4, 5]);
    }
    ...
    public void Test_Select_SourceTraverse()
    {
        ...
        rel1.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3, 4, 5, 6, 7, 8, null, 9]);
        rel2.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3, 4, 5, 6, 7, 8, null, 9]);
        rel3.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3, 4, 5, 6, 7, 8, null, 9]);
        rel4.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3, 4, 5, 6, 7, 8, null, 9]);
        rel5.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3, 4, 5, 6]);
        rel6.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3, 4, 5, 6]);
        rel7.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3, 4, 5, 6]);
        rel8.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3]);
        rel9.Column().Select(f => (int?)f.Snapshot).ShouldBe([1, 2, 3]);
        rel10.Column().Select(f => (int?)f.Snapshot).ShouldBe([1]);
        rel11.Column().Select(f => (int?)f.Snapshot).ShouldBe([1]);
    }
    ...
    public void Test_Select_OneToMany_InnerJoin()
    {
        ...
        var model = new List<RootModel>()
        {
            ...
            new RootModel() { IntValue = 4, ComplexList = [] },
        };
        ...
        result[0].Select(f => (int)f.Snapshot).ShouldBe([1, 10]);
        result[0].Select(f => f.Identity.Name).ShouldBe(["Item[0].IntValue", "Item[0].ComplexList.Item[0].Value"]);

        result[1].Select(f => (int)f.Snapshot).ShouldBe([2, 11]);
        result[1].Select(f => f.Identity.Name).ShouldBe(["Item[1].IntValue", "Item[1].ComplexList.Item[0].Value"]);

        result[2].Select(f => (int)f.Snapshot).ShouldBe([2, 12]);
        result[2].Select(f => f.Identity.Name).ShouldBe(["Item[1].IntValue", "Item[1].ComplexList.Item[1].Value"]);
    }
    ...
    public void Test_Select_ScalarList()
    {
        ...
        result.Select(f => (int)f.Snapshot).ShouldBe([1, 2, 3, 4, 5]);
        result.Select(f => f.Identity.Name).ShouldBe(["IntList.Item[0]", "IntList.Item[1]", "IntList.Item[2]", "IntList.Item[3]", "IntList.Item[4]"]);
    }
    ...
    public void Test_Select_Adjacent_CrossJoin()
    {
        ...
        data1[0].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[0]", "Ys.Item[0]", "Zs.Item[0]"]);
        data1[1].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[0]", "Ys.Item[0]", "Zs.Item[1]"]);
        data1[2].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[0]", "Ys.Item[0]", "Zs.Item[2]"]);
        data1[3].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[0]", "Ys.Item[1]", "Zs.Item[0]"]);
        data1[4].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[0]", "Ys.Item[1]", "Zs.Item[1]"]);
        data1[5].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[0]", "Ys.Item[1]", "Zs.Item[2]"]);

        data1[6].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[1]", "Ys.Item[0]", "Zs.Item[0]"]);
        data1[7].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[1]", "Ys.Item[0]", "Zs.Item[1]"]);
        data1[8].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[1]", "Ys.Item[0]", "Zs.Item[2]"]);
        data1[9].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[1]", "Ys.Item[1]", "Zs.Item[0]"]);
        data1[10].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[1]", "Ys.Item[1]", "Zs.Item[1]"]);
        data1[11].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[1]", "Ys.Item[1]", "Zs.Item[2]"]);

        data1[12].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[2]", "Ys.Item[0]", "Zs.Item[0]"]);
        data1[13].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[2]", "Ys.Item[0]", "Zs.Item[1]"]);
        data1[14].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[2]", "Ys.Item[0]", "Zs.Item[2]"]);
        data1[15].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[2]", "Ys.Item[1]", "Zs.Item[0]"]);
        data1[16].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[2]", "Ys.Item[1]", "Zs.Item[1]"]);
        data1[17].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[2]", "Ys.Item[1]", "Zs.Item[2]"]);

        data1[18].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[3]", "Ys.Item[0]", "Zs.Item[0]"]);
        data1[19].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[3]", "Ys.Item[0]", "Zs.Item[1]"]);
        data1[20].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[3]", "Ys.Item[0]", "Zs.Item[2]"]);
        data1[21].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[3]", "Ys.Item[1]", "Zs.Item[0]"]);
        data1[22].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[3]", "Ys.Item[1]", "Zs.Item[1]"]);
        data1[23].Select(f => f.Identity.Name).ShouldBe(["Xs.Item[3]", "Ys.Item[1]", "Zs.Item[2]"]);

        data1[0].Select(f => (int)f.Snapshot).ShouldBe([1, 5, 7]);
        data1[1].Select(f => (int)f.Snapshot).ShouldBe([1, 5, 8]);
        data1[2].Select(f => (int)f.Snapshot).ShouldBe([1, 5, 9]);
        data1[3].Select(f => (int)f.Snapshot).ShouldBe([1, 6, 7]);
        data1[4].Select(f => (int)f.Snapshot).ShouldBe([1, 6, 8]);
        data1[5].Select(f => (int)f.Snapshot).ShouldBe([1, 6, 9]);

        data1[6].Select(f => (int)f.Snapshot).ShouldBe([2, 5, 7]);
        data1[7].Select(f => (int)f.Snapshot).ShouldBe([2, 5, 8]);
        data1[8].Select(f => (int)f.Snapshot).ShouldBe([2, 5, 9]);
        data1[9].Select(f => (int)f.Snapshot).ShouldBe([2, 6, 7]);
        data1[10].Select(f => (int)f.Snapshot).ShouldBe([2, 6, 8]);
        data1[11].Select(f => (int)f.Snapshot).ShouldBe([2, 6, 9]);

        data1[12].Select(f => (int)f.Snapshot).ShouldBe([3, 5, 7]);
        data1[13].Select(f => (int)f.Snapshot).ShouldBe([3, 5, 8]);
        data1[14].Select(f => (int)f.Snapshot).ShouldBe([3, 5, 9]);
        data1[15].Select(f => (int)f.Snapshot).ShouldBe([3, 6, 7]);
        data1[16].Select(f => (int)f.Snapshot).ShouldBe([3, 6, 8]);
        data1[17].Select(f => (int)f.Snapshot).ShouldBe([3, 6, 9]);

        data1[18].Select(f => (int)f.Snapshot).ShouldBe([4, 5, 7]);
        data1[19].Select(f => (int)f.Snapshot).ShouldBe([4, 5, 8]);
        data1[20].Select(f => (int)f.Snapshot).ShouldBe([4, 5, 9]);
        data1[21].Select(f => (int)f.Snapshot).ShouldBe([4, 6, 7]);
        data1[22].Select(f => (int)f.Snapshot).ShouldBe([4, 6, 8]);
        data1[23].Select(f => (int)f.Snapshot).ShouldBe([4, 6, 9]);

        data2.Length.ShouldBe(3 * 2 * 4);

        data2[0].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[0]", "Ys.Item[0]", "Xs.Item[0]"]);
        data2[1].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[0]", "Ys.Item[0]", "Xs.Item[1]"]);
        data2[2].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[0]", "Ys.Item[0]", "Xs.Item[2]"]);
        data2[3].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[0]", "Ys.Item[0]", "Xs.Item[3]"]);

        data2[4].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[0]", "Ys.Item[1]", "Xs.Item[0]"]);
        data2[5].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[0]", "Ys.Item[1]", "Xs.Item[1]"]);
        data2[6].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[0]", "Ys.Item[1]", "Xs.Item[2]"]);
        data2[7].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[0]", "Ys.Item[1]", "Xs.Item[3]"]);

        data2[8].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[1]", "Ys.Item[0]", "Xs.Item[0]"]);
        data2[9].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[1]", "Ys.Item[0]", "Xs.Item[1]"]);
        data2[10].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[1]", "Ys.Item[0]", "Xs.Item[2]"]);
        data2[11].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[1]", "Ys.Item[0]", "Xs.Item[3]"]);

        data2[12].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[1]", "Ys.Item[1]", "Xs.Item[0]"]);
        data2[13].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[1]", "Ys.Item[1]", "Xs.Item[1]"]);
        data2[14].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[1]", "Ys.Item[1]", "Xs.Item[2]"]);
        data2[15].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[1]", "Ys.Item[1]", "Xs.Item[3]"]);

        data2[16].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[2]", "Ys.Item[0]", "Xs.Item[0]"]);
        data2[17].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[2]", "Ys.Item[0]", "Xs.Item[1]"]);
        data2[18].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[2]", "Ys.Item[0]", "Xs.Item[2]"]);
        data2[19].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[2]", "Ys.Item[0]", "Xs.Item[3]"]);

        data2[20].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[2]", "Ys.Item[1]", "Xs.Item[0]"]);
        data2[21].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[2]", "Ys.Item[1]", "Xs.Item[1]"]);
        data2[22].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[2]", "Ys.Item[1]", "Xs.Item[2]"]);
        data2[23].Select(f => f.Identity.Name).ShouldBe(["Zs.Item[2]", "Ys.Item[1]", "Xs.Item[3]"]);

        data2[0].Select(f => (int)f.Snapshot).ShouldBe([7, 5, 1]);
        data2[1].Select(f => (int)f.Snapshot).ShouldBe([7, 5, 2]);
        data2[2].Select(f => (int)f.Snapshot).ShouldBe([7, 5, 3]);
        data2[3].Select(f => (int)f.Snapshot).ShouldBe([7, 5, 4]);

        data2[4].Select(f => (int)f.Snapshot).ShouldBe([7, 6, 1]);
        data2[5].Select(f => (int)f.Snapshot).ShouldBe([7, 6, 2]);
        data2[6].Select(f => (int)f.Snapshot).ShouldBe([7, 6, 3]);
        data2[7].Select(f => (int)f.Snapshot).ShouldBe([7, 6, 4]);

        data2[8].Select(f => (int)f.Snapshot).ShouldBe([8, 5, 1]);
        data2[9].Select(f => (int)f.Snapshot).ShouldBe([8, 5, 2]);
        data2[10].Select(f => (int)f.Snapshot).ShouldBe([8, 5, 3]);
        data2[11].Select(f => (int)f.Snapshot).ShouldBe([8, 5, 4]);

        data2[12].Select(f => (int)f.Snapshot).ShouldBe([8, 6, 1]);
        data2[13].Select(f => (int)f.Snapshot).ShouldBe([8, 6, 2]);
        data2[14].Select(f => (int)f.Snapshot).ShouldBe([8, 6, 3]);
        data2[15].Select(f => (int)f.Snapshot).ShouldBe([8, 6, 4]);

        data2[16].Select(f => (int)f.Snapshot).ShouldBe([9, 5, 1]);
        data2[17].Select(f => (int)f.Snapshot).ShouldBe([9, 5, 2]);
        data2[18].Select(f => (int)f.Snapshot).ShouldBe([9, 5, 3]);
        data2[19].Select(f => (int)f.Snapshot).ShouldBe([9, 5, 4]);

        data2[20].Select(f => (int)f.Snapshot).ShouldBe([9, 6, 1]);
        data2[21].Select(f => (int)f.Snapshot).ShouldBe([9, 6, 2]);
        data2[22].Select(f => (int)f.Snapshot).ShouldBe([9, 6, 3]);
        data2[23].Select(f => (int)f.Snapshot).ShouldBe([9, 6, 4]);
    }
